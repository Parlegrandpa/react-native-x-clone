...
import AllNotificationTab from "./tabscreens/AllNotificationTab";

const NotificationTabComponent = ({
  onScroll,
  headerHeight,
  animatedHeaderStyle,
  backgroundColor,
  ...
  const renderScene = SceneMap({
    first: () => (
      <AllNotificationTab onScroll={onScroll} height={headerHeight} />
    ),
